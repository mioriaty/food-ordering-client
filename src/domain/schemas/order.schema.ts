import { AccountSchema } from '@/domain/schemas/account.schema';
import { TableSchema } from '@/domain/schemas/table.schema';
import { DishStatusValues, OrderStatusValues } from '@/libs/constants/type';
import z from 'zod';
