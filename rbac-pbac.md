...
Hệ thống quản lý món ăn gồm 3 role chính:

- Admin: Có quyền thao tác mọi chức năng trên hệ thống.
- Employee: Có quyền thao tác một số chức năng như tạp order, xem order nhưng không thể quản lý nhân viên khác được.
- Guest: Chỉ có quyền xem menu, tạo order.

Các quyền hạn ở mỗi role thường được định nghĩa cố định khi code. Tất nhiên ta cũng có thể code 1 hệ thống thay đổi
quyền hạn mỗi role 1 cách linh hoạt hơn. Lưu ý là thay đổi quyền hạn trên mỗi role chứ không phải trên mỗi tài khoản.
...
Đây vừa là ưu vừa là nhược điểm:

- Nó linh hoạt hơn RBAC vì có thể thêm quyền hạn mới mà không cần tạo lại role mới.
- Nhưng cũng khó kiểm tra các tài khoản nếu có quá nhiều quyền hạn, có quá nhiều tài khoản.
